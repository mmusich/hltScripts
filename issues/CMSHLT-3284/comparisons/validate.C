...
void validateEvents(TString step, TString file, TString refFile, TString r="RECO", bool SHOW=false, TString sr="")
{
  ...
  if (!stepContainsNU(step, "hlt")){
    ...
    if ((stepContainsNU(step, "all"))) {
      ...
      trackExtras("hltPixelTracksPPOnAA_");
      trackExtras("hltIterL3OIMuCtfWithMaterialTracksPPOnAA_");
      trackExtras("hltIterL3MuonMergedPPOnAA_");
      trackExtras("hltIterL3MuonTracksPPOnAA_");
      trackExtras("hltIterL3GlbMuonPPOnAA_");
      trackExtras("hltIterL3OIMuonTrackSelectionHighPurityPPOnAA_");
      trackExtras("hltL3MuonsIterL3OIPPOnAA_");
      trackExtras("hltIter0IterL3MuonCtfWithMaterialTracksPPOnAA_");
      trackExtras("hltL2MuonsPPOnAA_");
      trackExtras("hltIter0IterL3MuonTrackSelectionHighPurityPPOnAA_");
      trackExtras("hltL3MuonsIterL3IOPPOnAA_");
