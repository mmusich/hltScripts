...
void generalTrack(TString var){
  ...
  plotTrack("hltPixelTracksInRegionL2PPOnAA",var);
  plotTrack("hltL2MuonsPPOnAA_UpdatedAtVtx",var);
  plotTrack("hltIterL3OIMuonTrackSelectionHighPurityPPOnAA",var);
  plotTrack("hltIterL3MuonAndMuonFromL1MergedPPOnAA",var);
  plotTrack("hltL2MuonsPPOnAA",var);
  plotTrack("hltIterL3MuonMergedPPOnAA",var);
  plotTrack("hltL3MuonsIterL3OIPPOnAA",var);
  plotTrack("hltIterL3OIL3MuonsPPOnAA",var);
  plotTrack("hltIterL3GlbMuonPPOnAA",var);
  plotTrack("hltIterL3MuonTracksPPOnAA",var);
  plotTrack("hltL2SelectorForL3IOPPOnAA",var);
  plotTrack("hltIter0IterL3FromL1MuonCtfWithMaterialTracksPPOnAA",var);
  plotTrack("hltIter0IterL3FromL1MuonTrackSelectionHighPurityPPOnAA",var);
  plotTrack("hltIter0IterL3MuonTrackSelectionHighPurityPPOnAA",var);
  plotTrack("hltIter0IterL3MuonCtfWithMaterialTracksPPOnAA",var);
  plotTrack("hltL3MuonsIterL3IOPPOnAA_L2Seeded",var);
  plotTrack("hltL3MuonsIterL3OIPPOnAA_L2Seeded",var);
  plotTrack("hltIterL3GlbMuonPPOnAA_L2Seeded",var);
  plotTrack("hltL3MuonsIterL3IOPPOnAA",var);  
...
void validateEvents(TString step, TString file, TString refFile, TString r="RECO", bool SHOW=false, TString sr="")
{
  ...
  if (!stepContainsNU(step, "hlt")){
    ...
    if ((stepContainsNU(step, "all"))) {
      ...
      allTracks("hltFullIter0CtfWithMaterialTracksPreSplittingPPRefForDmeson__"+recoS);
      allTracks("hltFullIterativeTrackingMergedPPRefForDmeson__"+recoS);
      allTracks("hltFullIter5CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter0CtfWithMaterialTracksPPRefForDmeson__"+recoS);
      allTracks("hltFullIter0HighPurityTracksPPRefForDmeson__"+recoS);
      allTracks("hltFullIter5HighPurityTracksPPRef__"+recoS);
      allTracks("hltFullIter2CtfWithMaterialTracksPPRefForDmeson__"+recoS);
      allTracks("hltFullIter10CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter2HighPurityTracksPPRefForDmeson__"+recoS);
      allTracks("hltFullIter3CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter3HighPurityTracksPPRef__"+recoS);
      allTracks("hltFullIter1CtfWithMaterialTracksPPRefForDmeson__"+recoS);
      allTracks("hltFullIter1HighPurityTracksPPRefForDmeson__"+recoS);
      allTracks("hltFullIter7CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter7HighPurityTracksPPRef__"+recoS);
      allTracks("hltFullIter6CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter4CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter6HighPurityTracksPPRef__"+recoS);
      allTracks("hltFullIter4HighPurityTracksPPRef__"+recoS);
      allTracks("hltFullIter9CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter8CtfWithMaterialTracksPPRef__"+recoS);
      allTracks("hltFullIter8HighPurityTracksPPRef__"+recoS);


      trackExtras("hltFullIter0CtfWithMaterialTracksPreSplittingPPRefForDmeson_");
      trackExtras("hltFullIterativeTrackingMergedPPRefForDmeson_");
      trackExtras("hltFullIter5CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter0CtfWithMaterialTracksPPRefForDmeson_");
      trackExtras("hltFullIter0HighPurityTracksPPRefForDmeson_");
      trackExtras("hltFullIter5HighPurityTracksPPRef_");
      trackExtras("hltFullIter2CtfWithMaterialTracksPPRefForDmeson_");
      trackExtras("hltFullIter10CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter2HighPurityTracksPPRefForDmeson_");
      trackExtras("hltFullIter3CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter3HighPurityTracksPPRef_");
      trackExtras("hltFullIter1CtfWithMaterialTracksPPRefForDmeson_");
      trackExtras("hltFullIter1HighPurityTracksPPRefForDmeson_");
      trackExtras("hltFullIter7CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter7HighPurityTracksPPRef_");
      trackExtras("hltFullIter6CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter4CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter6HighPurityTracksPPRef_");
      trackExtras("hltFullIter4HighPurityTracksPPRef_");
      trackExtras("hltFullIter9CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter8CtfWithMaterialTracksPPRef_");
      trackExtras("hltFullIter8HighPurityTracksPPRef_");

      allTrajectorySeeds("hltFullIter5PixelSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter2PixelSeedsPPRefForDmeson__"+recoS);
      allTrajectorySeeds("hltFullIter0PixelSeedsPreSplittingPPRefForDmeson__"+recoS);
      allTrajectorySeeds("hltFullIter0PixelSeedsPPRefForDmeson__"+recoS);
      allTrajectorySeeds("hltFullIter3PixelSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter1PixelSeedsPPRefForDmeson__"+recoS);
      allTrajectorySeeds("hltFullIter4PixelSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter7MixedSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter7MixedSeedsAPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter6PixelSeedsBPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter10JetCoreRegionSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter8PixelLessSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter9TobTecSeedsPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter9TobTecSeedsTriplPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter9TobTecSeedsPairPPRef__"+recoS);
      allTrajectorySeeds("hltFullIter7MixedSeedsBPPRef__"+recoS);
      
      allTrackCandidates("hltFullIter0CkfTrackCandidatesPreSplittingPPRefForDmeson__"+recoS);
      allTrackCandidates("hltFullIter0CkfTrackCandidatesPPRefForDmeson__"+recoS);
      allTrackCandidates("hltFullIter5CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter2CkfTrackCandidatesPPRefForDmeson__"+recoS);
      allTrackCandidates("hltFullIter10CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter3CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter1CkfTrackCandidatesPPRefForDmeson__"+recoS);
      allTrackCandidates("hltFullIter7CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter6CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter4CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter9CkfTrackCandidatesPPRef__"+recoS);
      allTrackCandidates("hltFullIter8CkfTrackCandidatesPPRef__"+recoS);
    ...
    if ((stepContainsNU(step, "all") || stepContainsNU(step, "sipixel")) && !stepContainsNU(step, "cosmic") ){
      ...
      siPixelClusters("hltSiPixelClustersPPOnAA_");      
    ...
    if ((stepContainsNU(step, "all") || stepContainsNU(step, "track")) && !stepContainsNU(step, "cosmic") ){
      ...
      allTracks("hltPixelTracksPPOnAA__"+recoS);
      allTracks("hltIterL3OIMuCtfWithMaterialTracksPPOnAA__"+recoS);
      allTracks("hltPixelTracksInRegionL2PPOnAA__"+recoS);
      allTracks("hltL2MuonsPPOnAA_UpdatedAtVtx__"+recoS);
      allTracks("hltIterL3OIMuonTrackSelectionHighPurityPPOnAA__"+recoS);
      allTracks("hltIterL3MuonAndMuonFromL1MergedPPOnAA__"+recoS);
      allTracks("hltL2MuonsPPOnAA__"+recoS);
      allTracks("hltIterL3MuonMergedPPOnAA__"+recoS);
      allTracks("hltL3MuonsIterL3OIPPOnAA__"+recoS);
      allTracks("hltIterL3OIL3MuonsPPOnAA__"+recoS);
      allTracks("hltIterL3GlbMuonPPOnAA__"+recoS);
      allTracks("hltIterL3MuonTracksPPOnAA__"+recoS);
      allTracks("hltL2SelectorForL3IOPPOnAA__"+recoS);
      allTracks("hltIter0IterL3FromL1MuonCtfWithMaterialTracksPPOnAA__"+recoS);
      allTracks("hltIter0IterL3FromL1MuonTrackSelectionHighPurityPPOnAA__"+recoS);
      allTracks("hltIter0IterL3MuonTrackSelectionHighPurityPPOnAA__"+recoS);
      allTracks("hltIter0IterL3MuonCtfWithMaterialTracksPPOnAA__"+recoS);
      allTracks("hltL3MuonsIterL3IOPPOnAA_L2Seeded__"+recoS);
