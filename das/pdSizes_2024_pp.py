...
if __name__ == '__main__':
    ...
    pd_dict = {
        'PhysicsMuon': [
            ['/Muon*/Run2024*/RAW','/Muon[0-9]+/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'PhysicsEGamma': [
            ['/EGamma*/Run2024*/RAW', '/EGamma[0-9]+/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'PhysicsJetMET': [
            ['/JetMET*/Run2024*/RAW', '/JetMET[0-9]+/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'PhysicsOthers': [
            ['/BTagMu/Run2024*/RAW', '/BTagMu/Run2024[B-I]-v[0-9]+/RAW'],
            ['/Commissioning/Run2024*/RAW','/Commissioning/Run2024[B-I]-v[0-9]+/RAW'],
            ['/DisplacedJet/Run2024*/RAW','/DisplacedJet/Run2024[B-I]-v[0-9]+/RAW'],
            ['/HLTPhysics/Run2024*/RAW','/HLTPhysics/Run2024[B-I]-v[0-9]+/RAW'],
            ['/HcalNZS/Run2024*/RAW','/HcalNZS/Run2024[B-I]-v[0-9]+/RAW'],
            ['/NoBPTX/Run2024*/RAW','/NoBPTX/Run2024[B-I]-v[0-9]+/RAW'],
            ['/ZeroBias/Run2024*/RAW','/ZeroBias/Run2024[B-I]-v[0-9]+/RAW'],
            ['/Tau/Run2024*/RAW','/Tau/Run2024[B-I]-v[0-9]+/RAW'],
            ['/ScoutingPFMonitor/Run2024*/RAW','/ScoutingPFMonitor/Run2024[B-I]-v[0-9]+/RAW'],
        ],

        'ParkingSingleMuon': [
            ['/ParkingSingleMuon*/Run2024*/RAW', '/ParkingSingleMuon[0-9]+/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'ParkingDoubleMuonLowMass': [
            ['/ParkingDoubleMuonLowMass*/Run2024*/RAW', '/ParkingDoubleMuonLowMass[0-9]+/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'ParkingVBF': [
            ['/ParkingVBF*/Run2024*/RAW', '/ParkingVBF[0-9]+/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'ParkingHH': [
            ['/ParkingHH/Run2024*/RAW', '/ParkingHH/Run2024[B-I]-v[0-9]+/RAW'],
        ],
        'ParkingLLP': [
            ['/ParkingLLP/Run2024*/RAW', '/ParkingLLP/Run2024[B-I]-v[0-9]+/RAW'],
        ],

        'HLT-Scouting': [
            ['/ScoutingPFRun3/Run2024*/HLTSCOUT', '/ScoutingPFRun3/Run2024[B-I]-v[0-9]+/HLTSCOUT'],
        ],
    }
