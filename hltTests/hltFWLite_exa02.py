...
def analyse_event(event, verbosity=0):
    ...
    hltMergedTracksInputTagLabel = 'hltMergedTracks'
    hltMergedTracksHandle = Handle('std::vector<reco::Track>')
    event.getByLabel(hltMergedTracksInputTagLabel, hltMergedTracksHandle)
    hltMergedTracks = hltMergedTracksHandle.product()
    ...
    if verbosity >= 0:
      ...
      print('\n'+'-'*10)
      for hltMergedTrack_idx in range(len(hltMergedTracks)):
        print('hltMergedTracks #{:d}'.format(hltMergedTrack_idx), hltMergedTracks[hltMergedTrack_idx].pt(), hltMergedTracks[hltMergedTrack_idx].eta(), hltMergedTracks[hltMergedTrack_idx].phi())
