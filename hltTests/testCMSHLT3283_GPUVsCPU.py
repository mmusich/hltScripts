...
if __name__ == '__main__':
    ...
    eosDirs = [f'/eos/cms/store/data/Run2024F/EphemeralHLTPhysics{foo}/RAW/v1/000/383/631/00000' for foo in range(7)]

    hltLabel = sys.argv[1]

    hltMenu = 'adg:/cdaq/physics/Run2024/2e34/v1.4.1/HLT/V1'
