...
if __name__ == '__main__':
    ...
    hltMenu1 = '/users/missirol/test/dev/CMSSW_15_0_0/CMSHLT_3534/Test03/GRun/V1'
    hltMenu2 = '/users/missirol/test/dev/CMSSW_15_0_0/CMSHLT_3534/Test03/GRun/V2'
...
hltGetConfiguration {hltMenu} \
  --process HLTX \
  --globaltag 150X_dataRun3_HLT_forTriggerStudies_v6 \
  --data \
  --prescale "2p0E34" \
  --output minimal \
...
"""
    ...
    hltCfgTypes = {
        f'{hltLabel1}_GTv6': config_baseline,
        f'{hltLabel2}_GTv6': config_target,
    }
