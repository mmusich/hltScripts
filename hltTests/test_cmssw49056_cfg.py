...
process.gtStage2Digis2 = cms.EDProducer( "L1TGlobalProducer",
    MuonInputTag = cms.InputTag( 'gmtStage2Digis','Muon' ),
    MuonShowerInputTag = cms.InputTag( '' ),
    EGammaInputTag = cms.InputTag( 'caloStage2Digis','EGamma' ),
    TauInputTag = cms.InputTag( 'caloStage2Digis','Tau' ),
    JetInputTag = cms.InputTag( 'caloStage2Digis','Jet' ),
    EtSumInputTag = cms.InputTag( 'caloStage2Digis','EtSum' ),
