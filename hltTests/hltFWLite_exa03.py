        ...
        try:
          ...
          for hltRecoPixelSeed_idx in range(len(hltRecoPixelSeeds)):
            ...
            print(hltRecoPixelSeedsLabel+' #{:d}'.format(hltRecoPixelSeed_idx),
                  hltRecoPixelSeed.nHits(), hltRecoPixelSeed.direction(),
                  hltRecoPixelSeed.recHits().begin().rawId(),
                  hltRecoPixelSeed.recHits().begin().weight(),
                  hltRecoPixelSeed.recHits().begin().getRTTI(),
                  hltRecoPixelSeed.recHits().begin().type())
        except:
