...
def analyse_event(event, verbosity=0):
    ...
    rawData1 = getRawData('rawDataSiStripV1')
    rawData2 = getRawData('rawDataSiStripV2')

    for fedId in range(4096+2):
      print(fedId, rawData1.FEDData(fedId).size(), rawData2.FEDData(fedId).size())
